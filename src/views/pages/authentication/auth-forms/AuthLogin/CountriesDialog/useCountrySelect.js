...
export const useCountrySelect = (defaultValue) => {
    /**
     * Fetch countries list
     *
     * Note: For now API return ivalid data,
     * thats why we cannot use fetching countries.
    ...
    /**
     * Dirty flag used to indicate that the
     * country is only checked but not selected
     */
