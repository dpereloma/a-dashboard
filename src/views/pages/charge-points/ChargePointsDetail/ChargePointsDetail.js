...
import { Done, PowerOutlined, ShowChart, ArrowBackIos, ExpandMore } from '@mui/icons-material';
    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', gap: '16px', margin: '16px 0' }}>
                <MainCard sx={{ width: '100%' }} title={<ItemCardInfo title="title1" value="value1" img={<Done />} />} content={false} />
                <MainCard
                    sx={{ width: '100%' }}
                    title={<ItemCardInfo title="title1" value="value1" img={<PowerOutlined />} />}
                    content={false}
                />
                <MainCard
                    sx={{ width: '100%' }}
                    title={<ItemCardInfo title="title1" value="value1" img={<ShowChart />} />}
                    content={false}
                />
            </Box>
            <MainCard
            ...
            >
                <Box sx={{ display: 'flex', marginBottom: '16px', justifyContent: 'space-between', alignItems: 'center' }}>
